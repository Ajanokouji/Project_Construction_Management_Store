...
namespace _3.GUI.View.BanHang
{
	public partial class FrmGioHang : Form
	{
		...
		public void LoadSanPham()
		{
			...
			{
				dtgv_sanPham.Rows.Add(item.SanPhamChiTiets.IDSanPhamChiTiet, item.SanPhamChiTiets.maSP, item.SanPhamChiTiets.TenSP, item.SanPhamChiTiets.Giaban, item.hangSXs.tenHangSX, item.SanPhamChiTiets.Soluong);
			}
			dtgv_sanPham.Columns[0].Visible = false;
			dtgv_sanPham.Columns[6].Visible = false;
			dtgv_sanPham.Columns[7].Visible = false;
		}
		...
		private void btn_TaoHoaDon_Click(object sender, EventArgs e)
		{
			if (_lstViewHoaDon.Any())
			{
				...
				var IDNV = _qLnhanVienServices.GetNhanVienFromDB().FirstOrDefault(x => x.nhanViens.email == Emailtmp).nhanViens.IDNhanVien;
				if (KH != null)
				{
			...
			else
			{
				...
				foreach (var item in timsize)
				{
					dtgv_sanPham.Rows.Add(item.SanPhamChiTiets.IDSanPhamChiTiet, item.SanPhamChiTiets.maSP,
						item.SanPhamChiTiets.TenSP, item.SanPhamChiTiets.Giaban, item.hangSXs.tenHangSX, item.SanPhamChiTiets.Soluong);
				}
			}
		}
		...
		private void pdhd_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
		{
			...
			//
			e.Graphics.DrawString("Vật liệu Poly", new System.Drawing.Font("Times New Roman", 15, FontStyle.Bold), Brushes.Black, new System.Drawing.Point(100, 20));
			...
			e.Graphics.DrawString(String.Format("Ghi chú: {0}", hd.ghiChu), new System.Drawing.Font("Times New Roman", 15, FontStyle.Bold), Brushes.Black, new System.Drawing.Point(w / 2 - 100, y + 100));
		}
